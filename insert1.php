...
$booker_usercode=  $_COOKIE['user_code1'];
...
$sql = "INSERT INTO booker_table (booker_grade, booker_class, booker_classnum, booker_festivaltype,booker_code1,booker_seat,festival_name,festival_sttime) 
